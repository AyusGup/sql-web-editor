...
import { updateRoleSchema, userIdParamSchema, userSearchSchema, userPaginationSchema } from "../../shared/zod/schema";
...
router.get("/admins", validateQueryParams(userPaginationSchema), superAdminController.listAdmins);
